...
contract PermissionsImplementation {
    ...
    RateLimitManager private rateLimitManager;
    ...
    constructor(
        ...
        rateLimitManager = RateLimitManager(_rateLimitManager);
    }
            ...
            if (orgManager.checkOrgActive(act_org)) {
                ...
                return
                    roleManager.transactionAllowed(
                        ...
                        act_uOrg,
                        typeOfxn
                    ) && rateLimitManager.transactionAllowed(_sender);
            }
        }
        return false;
    }
